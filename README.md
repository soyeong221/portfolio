...
센서와 하드웨어 제어부터 실시간 통신, 데이터 관리, 모니터링까지  
...
| 구분 | 프로젝트 | 주요 기술 | 핵심 내용 |
|---|---|---|---|
| ⭐ Featured | [AI Conveyor Process Control](./projects/ai-conveyor-control/) | Python · YOLO · Raspberry Pi · Arduino · MQTT | AI 객체 인식 기반 제품 분류 및 컨베이어 제어 |
