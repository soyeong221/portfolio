...
`C` `C++` `C#` `Python` `SQL` `WPF` `Raspberry Pi` `Arduino` `MQTT` `ROS2` `OpenCV`
...
| ⭐ [Smart Factory Production HMI](./projects/smart-factory-packaging/) | Python · PyQt5 · Raspberry Pi · MQTT · REST API | 생산 세션·실시간 생산현황·라인 제어를 연동한 작업자 HMI |
...
프로젝트 개요, 주요 기능, 시스템 흐름, 대표 트러블슈팅과 프로젝트 결과를 확인할 수 있습니다.
